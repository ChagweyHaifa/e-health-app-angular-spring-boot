...
public class EmailConstant {
    ...
    public static final String USERNAME = "haifachagwey@gmail.com";
    public static final String PASSWORD = "bnkCNj45Dtcauf";
    public static final String FROM_EMAIL = "support@gmail.com";
    public static final String CC_EMAIL = "";
    public static final String EMAIL_SUBJECT = "Doctor inscription on Medix.tn";
